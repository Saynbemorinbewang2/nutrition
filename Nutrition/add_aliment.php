...
<div class="grid">
  ...
  <nav class="navigation">
      <center><a>Ajouter Aliments</a></center>
      <?php
 if(isset($_GET['erreur'])){
 $err = $_GET['erreur'];
 if($err==3 || $err==4)
 echo "<p style='color:blue'>Aliment Ajouter avec succes <span class='heart'>✔</span>  <a href='space_admin.php'>cliquer ici pour le formulaire de connection</a></p>";
 }
 ?>
...
<img src="image/koki.png" >
 ...
 <form action="php_fonction/function_add_aliment.php" method="POST">
 
 <label><b>Nom</b></label><br>
 <input type="text" name="nom" placeholder="nom" required><br>

 <label><b>Description</b></label><br>
 <input type="text" name="description" placeholder="breve description"><br>
...
<label><b> APPORT NUTRITIF</b></label><br>
<input type="number" name="apport_nutritif" placeholder="apport nutritif" required><br>
